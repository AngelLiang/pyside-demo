...
class TimerLabel(QLabel):
    ...
    def __initVal(self):
        ...
        self.is_after_stop_reset_time = False
    ...
    def setAfterStopResetTime(self):
        self.is_after_stop_reset_time = True
    ...
    def setStartHMS(self):
        self.__startTime.setHMS(
            self.__start_hour, self.__start_min, self.__start_sec)
    ...
    def setEndHMS(self):
        ...
        self.__end_text_time = self.__endTime.addSecs(
            -1).toString(self.__format)
    ...
    def stop(self):
        try:
            if self.is_after_stop_reset_time:
                self.__resetTimer()
            self.__timer.stop()
            self.stopped.emit()
        except Exception as e:
